...
public class CustomTextInputLayout extends LinearLayout {
    ...
    public boolean isEllipsized(){
        return mCollapsingTextHelper.isEllipsized;
    }
    ...
    public CustomTextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHintEnabled = a.getBoolean(android.support.design.R.styleable.TextInputLayout_hintEnabled, true);
        wrapLength = a.length();
        setHint(a.getText(android.support.design.R.styleable.TextInputLayout_android_hint));
        mHintAnimationEnabled = a.getBoolean(
                android.support.design.R.styleable.TextInputLayout_hintAnimationEnabled, true);

        if (a.hasValue(android.support.design.R.styleable.TextInputLayout_android_textColorHint)) {
            mDefaultTextColor = mFocusedTextColor =
                    a.getColorStateList(android.support.design.R.styleable.TextInputLayout_android_textColorHint);
        }

        final int hintAppearance = a.getResourceId(
                android.support.design.R.styleable.TextInputLayout_hintTextAppearance, -1);
        if (hintAppearance != -1) {
            setHintTextAppearance(
                    a.getResourceId(android.support.design.R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        ...
        final boolean counterEnabled = a.getBoolean(
                android.support.design.R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(
                a.getInt(android.support.design.R.styleable.TextInputLayout_counterMaxLength, INVALID_MAX_LENGTH));
        mCounterTextAppearance = a.getResourceId(
                android.support.design.R.styleable.TextInputLayout_counterTextAppearance, 0);
        mCounterOverflowTextAppearance = a.getResourceId(
                android.support.design.R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);

        mPasswordToggleEnabled = a.getBoolean(
                android.support.design.R.styleable.TextInputLayout_passwordToggleEnabled, false);
        mPasswordToggleDrawable = a.getDrawable(android.support.design.R.styleable.TextInputLayout_passwordToggleDrawable);
        mPasswordToggleContentDesc = a.getText(
                android.support.design.R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (a.hasValue(android.support.design.R.styleable.TextInputLayout_passwordToggleTint)) {
            mHasPasswordToggleTintList = true;
            mPasswordToggleTintList = a.getColorStateList(
                    android.support.design.R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (a.hasValue(android.support.design.R.styleable.TextInputLayout_passwordToggleTintMode)) {
            mHasPasswordToggleTintMode = true;
            mPasswordToggleTintMode = ViewUtils.parseTintMode(
                    a.getInt(android.support.design.R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
        ...
        ViewCompat.setAccessibilityDelegate(this, new CustomTextInputLayout.TextInputAccessibilityDelegate());
    }
...
//            mOriginalHint = "Vamsi";
    ...
    static class SavedState extends AbsSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new ClassLoaderCreator<SavedState>() {
            ...
            @Override
            public CustomTextInputLayout.SavedState createFromParcel(Parcel in) {
                return new CustomTextInputLayout.SavedState(in, null);
            }

            @Override
            public CustomTextInputLayout.SavedState[] newArray(int size) {
                return new CustomTextInputLayout.SavedState[size];
            }
        };
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        CustomTextInputLayout.SavedState ss = new CustomTextInputLayout.SavedState(superState);
        if (mErrorShown) {
            ss.error = getError();
        }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof CustomTextInputLayout.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }
        CustomTextInputLayout.SavedState ss = (CustomTextInputLayout.SavedState) state;
